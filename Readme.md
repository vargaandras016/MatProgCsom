...
Elsőként implementáltunk egy saját KNN algoritmust, amivel egy adott dal műfaját szerettük volna kitalálni. Az algoritmusunk az első 30000 zenén tanult és a 30001. zene műfaját tippeltettük meg vele.

A módszer lényege, hogy bizonyos sztenderdizált numerikus változók alapján (nekünk ezek a danceability, energy, tempo és duration_ms voltak) euklideszi távolságot számolunk az ismeretlen műfajú dal és a másik 30000 dal között. Az algoritmus a k legközelebbi szomszédot vizsgálja és azt a műfajt tippeli, ami ezek között a leggyakrabban fordult elő. Ha holtverseny alakul ki, akkor pedig azt, amelyikkel először találkozott a tanuló adatbázisban. Mi a k értékét 5-nek választottuk. A tippünk nem talált, ez azért is lehet, mert a zenei piac ennél sokkal kiszámíthatatlanabb.
